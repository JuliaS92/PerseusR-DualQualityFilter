...
p <- add_argument(p, '-value2', default=30, help='Maximum value for second quality column')
...
# Making sure the columns names match and are in order
...
# Filtering the data based on both quality matrices
data_f <- data
if (argp$mode == 'border') {
